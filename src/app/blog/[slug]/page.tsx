    ...
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs text-text-muted">{frontmatter.readTime}</span>
          <span className="text-xs text-text-muted font-mono">{frontmatter.date}</span>
        </div>
        <h1 className="text-3xl md:text-4xl font-bold text-text-primary tracking-tight mb-4">
          {frontmatter.title}
        </h1>
        <p className="text-lg text-text-secondary leading-relaxed">{frontmatter.excerpt}</p>
      </div>
      ...
      <section className="mb-10">
        <h2 className="text-xs font-mono text-text-muted tracking-widest mb-6">COMMENTS</h2>
        <GiscusComments />
      </section>
