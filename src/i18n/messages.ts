export const messages = {
  ...
  es: {
    ...
    stats: {
      years: "Anos creando productos",
      records: "Registros optimizados",
      aws: "Servicios AWS en produccion",
      users: "Usuarios atendidos",
    },
    automation: {
      sectionTitle: "AUTOMATIZACION DE LA SEMANA",
      title: "Procesador de Documentos con IA",
      description:
        "Ingesta de PDFs, extraccion de datos estructurados con Claude API, almacenamiento en PostgreSQL. Desplegado en AWS Lambda con triggers de S3.",
    ...
    automations: {
      ...
      ctaHeading: "Recibe el blueprint antes que todos",
      ctaDescription:
        "Diagramas de arquitectura, guias de deploy, analisis de costos y codigo funcional. Cada semana. Gratis.",
    },
    blog: {
    ...
    newsletter: {
      ...
      whatYouGet: "LO QUE RECIBES CADA SEMANA",
      recentTemplates: "TEMPLATES RECIENTES Y PROXIMOS",
